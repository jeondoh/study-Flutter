...
class DoublePopup extends StatefulWidget {
  const DoublePopup({Key? key}) : super(key: key);

  @override
  State<DoublePopup> createState() => _DoublePopupState();
}
                        ...
                        child: Column(
                          children: [
                            SizedBox(
                              ...
                              //   key: indexNumber,
                              //   imgUrl:
                              //       'http://10.10.100.107/res/resize/HanaTest3/HANA${indexNumber}.gif',
                              //   onTap: () {},
                              // ),
                              child: Image.network(
    ...
    return GestureDetector(
      ...
      child: CachedNetworkImage(
        ...
        cacheManager: CacheManager(
          Config(
            '${key}3',
            repo: JsonCacheInfoRepository(databaseName: 'cacheName3'),
